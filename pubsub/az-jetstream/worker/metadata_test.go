	...
	testCases := []struct {
	...
	}{
		{
			...
			want: metadata{
				...
				MemoryStorage:         true,
				RateLimit:             20000,
				internalDeliverPolicy: jetstream.DeliverAllPolicy,
				internalAckPolicy:     jetstream.AckExplicitPolicy,
				Domain:                "hub",
		...
		},
		{
			...
			want: metadata{
				...
				DeliverPolicy:         "sequence",
				AckPolicy:             "all",
				internalDeliverPolicy: jetstream.DeliverByStartSequencePolicy,
				internalAckPolicy:     jetstream.AckAllPolicy,
				APIPrefix:             "HUB",
